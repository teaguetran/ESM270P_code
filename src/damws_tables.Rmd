...
```{r}
sedex_diff_2040s1_higher <-  read.csv(here("data", "sedexdiff_damws", "sedexdiff_damws_2040s1High.csv"))
sedex_diff_2040s1_lower <- read.csv(here("data", "sedexdiff_damws", "sedexdiff_damws_2040s1Low.csv"))
sedex_diff_2040s6_higher <-  read.csv(here("data", "sedexdiff_damws", "sedexdiff_damws_2040s6High.csv"))
sedex_diff_2040s6_lower <- read.csv(here("data", "sedexdiff_damws", "sedexdiff_damws_2040s6Low.csv"))
sedex_diff_2060s1_higher <-  read.csv(here("data", "sedexdiff_damws", "sedexdiff_damws_2060s1High.csv"))
sedex_diff_2060s1_lower <- read.csv(here("data", "sedexdiff_damws", "sedexdiff_damws_2060s1Low.csv"))
sedex_diff_2060s6_higher <-  read.csv(here("data", "sedexdiff_damws", "sedexdiff_damws_2060s6High.csv"))
sedex_diff_2060s6_lower <- read.csv(here("data", "sedexdiff_damws", "sedexdiff_damws_2060s6Low.csv"))
...
process_function <- function(sedex_diff) {
  sedex_diff_select <- sedex_diff %>% 
    clean_names() %>% 
    select(ws_id, dam_waters, area_km2, area_acres, gridcode) %>% 
    filter(area_km2 > 0) %>% 
...
colnames(joined_df) <- c("wsID", "Watershed_Name", "area_km2", "area_acres", "sedex_diff_2040s1_higher", "sedex_diff_2040s1_lower", "sedex_diff_2040s6_higher", "sedex_diff_2040s6_lower", "sedex_diff_2060s1_higher", "sedex_diff_2060s1_lower", "sedex_diff_2060s6_higher", "sedex_diff_2060s6_lower")
...
watershed_info <- sedex_diff_2040s1_higher %>% 
  select(ws_id, dam_waters, area_km2) %>% 
  as.data.frame() %>% 
  arrange(ws_id)

table_watershed_info <- watershed_info %>% kable(col.names = c("Watershed ID",
                                    "Subwatershed Name", 
                                    "Area in TCSI (km<sup>2</sup>)"),
                        caption = "Dam Watershed Information",
                        format.args = list(decimal.mark = '.', big.mark = ","),
                        escape = F) %>% 
  kable_styling(bootstrap_options = c("striped", "bordered", "condensed"),
                full_width = FALSE) %>% 
...
save_kable(table_2040, file = "sedex_diff_damws_2040table.png", self_contained = TRUE)

save_kable(table_2060, file = "sedex_diff_damws_2060table.png", self_contained = TRUE)

save_kable(table_watershed_info, file = "watershedinfo_damws.png", self_contained = TRUE)
